...
const config = {
  ...
  url: 'https://opslabhqx.github.io',
  // Adjusted baseUrl to ensure it ends with a slash for correct path resolution
  baseUrl: '/pages-docusaurus-template/',

  organizationName: 'opslabhqx', // Ensure this is your actual organization/user name
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          href: 'https://github.com/opslabhqx/',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} OpsLabHQ, Inc. Built with ❤️`,
    },
    prism: {
